...
void GameConfigWidget::CreateWidgets()
{
  ...
  // If this is set too late, it won't update properly on window creation.
  SetItalics();
  ...
  gfx_tabs->addTab(GetWrappedWidget(new HacksWidget(this, m_layer.get()), this, 125, 100),
                   tr("Hacks"));
  gfx_tabs->addTab(GetWrappedWidget(new AdvancedWidget(this, nullptr), this, 125, 100),
                   tr("Advanced"));
...
void GameConfigWidget::SetItalics()
{
  ...
  italics(m_depth_slider);
  italics(m_convergence_spin);
}
