...
void AdvancedWidget::CreateWidgets()
{
  ...
  m_bloom_fix_enable = new GraphicsBool(tr("Enabled"), Config::GFX_EFB_BLOOM_FIX_ENABLED);
  m_bloom_fix_skip = new GraphicsBool(tr("Skip First"), Config::GFX_EFB_BLOOM_FIX_SKIP_FIRST);
  m_bloom_fix_alt = new GraphicsBool(tr("Filter Less"), Config::GFX_EFB_BLOOM_FIX_ALT_FILTER);
  m_bloom_fix_downscale = new GraphicsBool(tr("Downscale"), Config::GFX_EFB_BLOOM_FIX_DOWNSCALE);
  m_bloom_fix_slider_width = new GraphicsSlider(0, EFB_WIDTH, Config::GFX_EFB_BLOOM_FIX_WIDTH, 1);
  m_bloom_fix_integer_width = new GraphicsInteger(0, EFB_WIDTH, Config::GFX_EFB_BLOOM_FIX_WIDTH, 1);
...
void AdvancedWidget::ConnectWidgets()
{
  ...
  // GraphicsSlider
  connect(m_bloom_fix_slider_width, &GraphicsSlider::valueChanged,
